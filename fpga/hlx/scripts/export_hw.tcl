...
set bd_path $build_location/projects/$project_name.srcs/sources_1/bd/system
...
write_hw_platform -fixed -force -file $build_location/$project_name.sdk/system_wrapper.xsa
