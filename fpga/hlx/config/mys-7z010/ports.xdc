...
set_property MARK_DEBUG true [get_nets system_i/axis_lcd_interface_v_0/inst/i_fifo/empty]
set_property MARK_DEBUG true [get_nets system_i/axis_lcd_interface_v_0/inst/i_fifo/full]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets lcd_clk_OBUF]
