# Copied form Vivado block design export
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_IMPORT_BOARD_PRESET {config/red-pitaya/red_pitaya.xml} \
  ...
  connect_bd_net -net blinker_v1_0_0_led [get_bd_ports led_o] [get_bd_pins blinker_v1_0_0/led]
  ...
  connect_bd_net -net ps_0_FCLK_CLK0 [get_bd_pins blinker_v1_0_0/aclk] [get_bd_pins ps_0/FCLK_CLK0]
  connect_bd_net -net ps_0_FCLK_RESET0_N [get_bd_pins blinker_v1_0_0/arstn] [get_bd_pins ps_0/FCLK_RESET0_N]
